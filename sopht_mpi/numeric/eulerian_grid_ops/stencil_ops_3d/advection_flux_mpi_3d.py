"""MPI-supported kernels for computing advection flux in 3D."""
...
def gen_advection_flux_conservative_eno3_pyst_mpi_kernel_3d(
    real_t, mpi_construct, ghost_exchange_communicator
):
    advection_flux_pyst_kernel = gen_advection_flux_conservative_eno3_pyst_kernel_3d(
        real_t=real_t
    )
    kernel_support = 2
    ...
    check_valid_ghost_size_and_kernel_support(
        ...
        kernel_support=gen_advection_flux_conservative_eno3_pyst_mpi_kernel_3d.kernel_support,
    )

    def advection_flux_conservative_eno3_pyst_mpi_kernel_3d(
        advection_flux, field, velocity, inv_dx
    ):
        # define kernel support for kernel
        advection_flux_conservative_eno3_pyst_mpi_kernel_3d.kernel_support = (
            gen_advection_flux_conservative_eno3_pyst_mpi_kernel_3d.kernel_support
        )
    ...
    return advection_flux_conservative_eno3_pyst_mpi_kernel_3d
